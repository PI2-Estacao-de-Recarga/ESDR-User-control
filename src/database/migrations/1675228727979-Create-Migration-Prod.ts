...
export class CreateMigrationProd1675228727979 implements MigrationInterface {
  name = 'CreateMigrationProd1675228727979'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "operation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "operationType" character varying NOT NULL, "creditAmount" integer NOT NULL, "userId" uuid, CONSTRAINT "PK_18556ee6e49c005fc108078f3ab" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "operation" ADD CONSTRAINT "FK_7df4a22dbf4c663666e21c21123" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "operation" DROP CONSTRAINT "FK_7df4a22dbf4c663666e21c21123"`
    )
    await queryRunner.query(
